...
fn main() {
    ...
    println!("Creating GL System Configurations...");
    cfg_aliases! {
        // Systems.
    ...
    println!("Outputting GL Bindings...");
    let mut file = File::create("gl_bindings.rs").expect("There was an error creating GL Bindings!");
